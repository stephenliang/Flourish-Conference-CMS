...
<p>
			...
			<table>
				...
				<tr>
					...
					<td><p>Troy Dawson is currently a senior software engineer working in the operations section of the Red Hat OpenShift project.  Prior to working for Red Hat, Troy worked for Fermilab for 18 years where he was one of two lead developers of Scientific Linux and Fermi Linux.</p></td>
					<td><h5>OpenShift: letting developers
develop</h5><p>OpenShift is a way for web developers that use Free and Open Source
...
care of the messy part, then the developer can concentrate on developing.</p></td>
				</tr>

				<tr>
					<td><img src="{#ROOT#}/images/speakers/hugs-headshot.jpg" class="small" alt="" /></a><span class="caption">Jason Huggins</span></td>
					<td><p>Jason Huggins co-founded Sauce Labs and currently leads product
					...
					<p>When not programming in Python or JavaScript, Jason enjoys hacking on
					Arduino-based electronics projects. Jason has spent time in New York
					City, LA, and the Bay Area, but Chicago is his kind of town.</p></td>
					<td><h5>Extreme Mobile Testing... with Robots!</h5>
					<p>Can your robot play Angry Birds? On an iPhone? Mine can. It's called
					...
					<p>An end-to-end test on an actual mobile device means the full
					...
					<p>This talk will cover the history of BitbeamBot, how to use it to test
					apps, how it's built, how you can build one yourself.</p>
					</td>
				</tr>
...
engineering manager for several Google products, a member of both the
Apache Software Foundation and the Open Web Foundation, a former
engineer at Apple and CollabNet, a Subversion developer, a
co-author of "Version Control with Subversion", and a resident of Chicago</p>
					</td>
					<td><h5>Data Liberation:
The Future of Your Data on the Web</h5>
					<p>As users, we're moving more and more of our data into web-based services and  we need to think more carefully about how we can get that data out of these services, how much control we have over our data, and where our data is going to be in ten or twenty years.  As technologists, we need to think more carefully about how we're treating the data of our users as we're making arbitrary technical decisions that are deeply affecting the future of collaboration and sharing on the web.  In this talk we'll review what my team at Google is doing about this, and what we're thinking about the control of our data in the future.</p>
					</td>
				</tr>
				<tr>
					<td><img src="{#ROOT#}/images/speakers/BryenYunashko.jpg" class="small" alt="" /></a><span class="caption">Bryen M. Yunashko</span></td>
					<td><p>Bryen Yunashko resides in Chicago and has traveled extensively giving
					...
					<p>When people see the name "openSUSE" they think of a great distro known
				...
				<tr>
					...
					<td><p>By day, Phil Gomes is a Senior Vice President at Edelman, the world's largest public relations firm. He has spoken to global public relations consortia about the intersection of PR and online communities and is well-known as the first PR professional to start a blog. Phil is also a founder of CREWE (Corporate Representative for Ethical Wikipedia Engagement) and helps guide its mission and efforts. 
</p>
					<p>By night, he tries to be a good husband and father, listens to way too much heavy metal, cultivates an appreciation for Brazilian distilled spirits, and reads more libertarian literature than is probably healthy or advisable. Phil has been part of the Flourish family since about 2008 and would have meaningfully volunteered this year if he weren't getting his MBA at Purdue University Calumet. We forgive him. This time.</p>
					</td>
