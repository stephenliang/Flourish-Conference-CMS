...
{include file="header.tpl" title="Mini Expo"}
			...
			<div class="essay">
				<span class="right-img"><a href="{#ROOT#}/images/about_history.jpg"><img src="{#ROOT#}/images/miniexpo_ps1.jpg" class="medium" /></a><div class="caption"><a href="http://pumpingstationone.org/">Pumping Station: One</a> at Flourish Conference 2011.</div></span>
