...
{include file="header.tpl" title="About Us"}
			...
			<h2>History</h2>
			<div class="essay">
				<span class="right-img"><a href="{#ROOT#}/images/about_history.jpg"><img src="{#ROOT#}/images/about_history.jpg" class="medium" /></a><div class="caption">Staff and Attendees during Flourish! Conference 2007.</div></span>
